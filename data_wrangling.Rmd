---
title: "Recepies of the traditional Russian salad ''Olivye''"
author: "G. Moroz"
output:
  html_document:
    df_print: paged
...
## 1. Introduction
There is a traditional salad called "Olivye" that ... I decided to analyse what is the recipe for this salad? What is the variability in ingredients of this salad? In order to answer this question I decided to provide two connected surveys:
...
I obtained data from `r length(unique(eda_recipies$link))` recipies. I already can list all unique `r length(unique(eda_recipies$ingredient))` ingridients and use it in the second survey. But lets try to visualise first. What is the most frequent ingredient in Olivye?
...
And here we see that the majority of Olivye salads should contain green peas, potates and carrot!
...
eda_recipies %>% 
  ...
  write_csv("eda_recipies_final.csv")
```
